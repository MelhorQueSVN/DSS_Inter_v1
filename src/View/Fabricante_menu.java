 ...
 * @author joaon
 */
public class Fabricante_menu extends javax.swing.JFrame {

    /**
     * Creates new form Fabricante_menu
     */
    public Fabricante_menu() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fabricante_menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fabricante_menu().setVisible(true);
            }
        });
    }
